...
par(mfrow=c(2,2))
plot(consomation$Date_Time,consomation$Global_active_power, type="l", xlab="",ylab="Global Active Power")
plot(consomation$Date_Time,consomation$Voltage, type="l", xlab="datetime",ylab="Voltage")
...
plot(consomation$Date_Time,consomation$Global_reactive_power, type="l", xlab="datetime",ylab="Global_reactive_power")
dev.off()